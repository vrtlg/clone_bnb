...
class HostsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create host" do
    assert_difference('Host.count') do
      post hosts_url, params: { host: { email: @host.email, name: @host.name, password: @host.password } }
    end
  ...
  test "should update host" do
    patch host_url(@host), params: { host: { email: @host.email, name: @host.name, password: @host.password } }
